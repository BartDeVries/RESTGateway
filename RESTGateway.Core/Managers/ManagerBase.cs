...
namespace RESTGateway.Core.Managers
{
    ...
    public class ManagerBase<TTableEntity> where TTableEntity : class, ITableEntity, new()
    {
        ...
        public ManagerBase(AppSettings settings, string tableReference)
        {


            TableReference = tableReference;

            storageAccount = CloudStorageAccount.Parse(settings.ConnectionStrings.AzureTablesConnection);
